...
const sessions = [
  {
    ...
    name: "20/02",
    color: "#f97316",
    avg: 139, max: 158, start: 85, wbs: "EMOM ~10' @9kg",
  ...
  },
  {
    ...
    name: "25/02",
    color: "#22d3ee",
    avg: 138, max: 151, start: 102, wbs: "EMOM 10' × 10/min @16lb",
  ...
  },
  {
    ...
    name: "27/02",
    color: "#a78bfa",
    avg: 136, max: 151, start: 107, wbs: "EMOM 11' × 10/min @16lb",
  ...
  },
  {
    ...
    name: "28/02",
    color: "#34d399",
    avg: 127, max: 147, start: 90, wbs: "EMOM 10' × 10/min @6kg",
  ...
  },
  {
    ...
    name: "04/03",
    color: "#f43f5e",
    avg: 140, max: 152, start: 107, wbs: "EMOM 11' × 10/min @6kg",
  ...
  },
  {
    ...
    name: "09/03",
    color: "#facc15",
    avg: 130, max: 164, start: 74, wbs: "EMOM 10' × 11/min @9kg",
  ...
  },
  {
    ...
    name: "17/03 ★",
    color: "#4ade80",
    avg: 147, max: 161, start: 95, wbs: "EMOM 10' × 12/min @9kg",
    ...
    <div style={{ background: "#0f0f1a", minHeight: "100vh", padding: "24px 16px", fontFamily: "system-ui, sans-serif", color: "#eee" }}>
      ...
      <div style={{ marginTop: 10, background: "#0d1f0d", borderRadius: 10, padding: "14px 16px", fontSize: 12, color: "#9ac", lineHeight: 1.8, border: "1px solid #1a3a1a" }}>
        ...
        <p style={{ margin: 0, color: "#aaa" }}>
          <span style={{ color: "#4ade80", fontWeight: 600 }}>EMOM 10' × 12 WB/min = 120 WB @9kg</span> — record de densité.
          ...
          Objectif : 100 WB unbroken en HYROX → 15+ WB/min en EMOM training 💪
        </p>
      </div>
    </div>
  );
