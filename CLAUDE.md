# CLAUDE.md — Projet HYROX Lyon 2026
> Fichier d'entrée pour Claude. Contexte projet, décisions clés, et objectifs.
> 📂 Voir aussi : `TECH.md` (stack & conventions) · `DATA.md` (perfs & historique sessions)
...
| **Objectif secondaire** | HYROX Paris Solo · Automne 2026 · cible < 1:15:00 |
...
├── TECH.md            ← Stack technique, conventions, workflow
...
| SkiErg | **Rémi** | Bonne technique · cible 4:15 |
| Rowing | **Rémi** | Aérobie solide · cible 4:45 |
| Sled Push | **Mélanie** | Plus forte en force |
| Sled Pull | **Mélanie** | Priorité (faiblesse Rémi : 5:15 à Nice) |
| Farmers Carry | **Mélanie** | Force fonctionnelle |
| Sandbag Lunges | **Mélanie** | Faiblesse Rémi |
| Burpee Broad Jump | **50/50** | Alternance 20 reps chacun · cible ~6:00 |
| Wall Ball | **50/50** | Alternance 50 reps chacun · cible ~7:00 |
...
- Velotaff quotidien : 6h Zone 1-2 / semaine
- HYROX pratiqué depuis 2024
